          ...
          <view class="flex-box">
            ...
            <view class="info-con flex-item">
              ...
              <view class="avator-box flex-box">
                <image class="avator" :src="al.avatarUrl" mode="widthFix"></image>
...
<script>
  ...
  import {apiAlbumDetail} from '@/api/index.js'
  export default {
    data() {
      return {
        album:{}, //音乐对象
        playList:[], //播放列表
        al:{} //res.playlist.creator
      }
    },
    onLoad(options) {
    ...
    methods: {
      ...mapMutations(['storePlayList','setPlayIndex']),
      //获取音乐列表
      getData(id){
        const params={
          id
